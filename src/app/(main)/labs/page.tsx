    ...
    <div className="md:pt-[57px] bg-grey11 md:bg-transparent grid gap-[80px] md:gap-[140px]">
      <div className="px-[16px] lg:px-[32px]">
        <div className="max-w-[1500px] mx-auto">
          <div className="lg:mx-[auto] w-full py-[16px] grid  md:pt-[0] md:grid-cols-[480px_1fr] gap-[40px] md:gap-x-[52px]">
            <div className="flex flex-col justify-between order-1 gap-[32px]">
              <div>
                ...
                <p className="text-grey6">
                  Know exactly where your ingredients come from—trust the
                  science, not brand marketing.
                </p>
              </div>
              <p className="font-bold text-blue underline  break-words">
                Make informed decisions about your supplements. Get access to
                the highest-quality ingredients—without the markups.
              </p>
            </div>
            ...
            <div className="grid order-2 pb-[18px] md:pb-[0]">
              ...
              <div className="text-grey6 whitespace-pre-line mt-[32px] md:mt-[40px]">
                ...
                world&apos;s leading laboratories, ensuring the highest purity
                and potency. Without middlemen or unnecessary markups, every
                product is third-party tested for quality and effectiveness.
                <br />
                <br />
                Unlike many brands that dilute their formulas with cheaper
                ingredients and offer vague labels, we provide clear,
                transparent sourcing. You&apos;ll know exactly how much of each
                active ingredient you&apos;re getting and why it works—no
                fillers, no hidden formulas.
                <br />
                <br />
                We partner with laboratories focused on ingredient
                integrity and clinical efficacy, so you can make informed
                decisions based on science rather than marketing. Our
                supplements deliver only what&apos;s needed, at a fraction of
                the cost.
              </div>
            </div>
          </div>
      ...
      <div className="md:pt-[57px] bg-grey11 md:bg-transparent grid gap-[80px] md:gap-[140px]">
        <div className="px-[16px] lg:px-[32px]">
          <div className="max-w-[1500px] mx-auto">
            <div className="lg:mx-[auto] py-[16px] w-[calc(100vw-32px)] md:w-auto">
              <div className="grid md:grid-cols-[1fr_335px]">
                <div>
                  ...
                  <div className="md:max-w-[550px] text-[14px] md:text-[20px] leading-[21px] md:leading-[30px] text-grey6 font-inconsolata">
                    ...
                    don&apos;t work. Know where your ingredients are coming
                    from.
                  </div>
                </div>
              </div>
      ...
      <div className="px-[16px] lg:px-[32px]">
        <div className="max-w-[1500px] mx-auto">
          <div className=" lg:mx-[auto] w-full py-[16px] grid md:grid-cols-3 md:gap-x-[16px] gap-y-[54px]">
      ...
      <div className="px-[16px] lg:px-[32px]">
        <div className="max-w-[1500px] mx-auto">
          <div className=" lg:mx-[auto] w-full py-[16px] grid gap-y-[16px] md:gap-[0] md:grid-cols-2">
            <div>
      ...
      <div className="px-[16px] lg:px-[32px]">
        <div className="max-w-[1500px] mx-auto">
          <div className="lg:mx-[auto] w-full py-[16px]">
            <Faqs />
          </div>
        </div>
      </div>
