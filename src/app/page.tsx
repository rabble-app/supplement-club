...
import type { IProductModel } from "@/utils/models/IProductModel";
...
export default function Home() {
	return (
		<div className="min-h-screen container-width grid lg:gap-y-[120px] bg-grey11 lg:bg-transparent">
			...
			<div className="grid grid-cols-2 lg:grid-cols-7 px-[16px] py-[80px] lg:p-[0]">
				{images.map((image) => (
					<div
						key={image.id}
			...
			<div className="lg:container-width relative bg-blue w-auto lg:bg-transparent">
				<div className="bg-blue px-[16px] lg:px-[32px] pt-[40px] pb-[76px] lg:mr-[270px] grid gap-[56px] lg:gap-[112px]">
					...
					<div className="max-w-[410px] order-4">
						...
						<div className="text-[40px] leading-[46px] font-[700] text-white mb-[2px] flex items-center">
							£45.00{" "}
						...
						<div className="text-[24px] leading-[27px] text-grey9 mb-[20px] lg:mb-[16px]">
							RRP{" "}
							<span className="text-[24px] leading-[27px] line-through font-[700]">
								£144
							</span>{" "}
							<span className="text-[24px] leading-[27px] font-[700] text-blue4">
								65% OFF
							</span>
						</div>
			...
			<div className="grid lg:grid-cols-[294px_1fr] items-start mx-[16px] py-[80px] lg:p-[0] lg:pb-[100px]">
				<p className="text-[32px] lg:text-[40px] leading-[36px] lg:leading-[55px] text-black3 lg:mb-[24px] lg:mb-[0]">
					FAQs
				</p>
				<div>
					{faqs.map((faq) => (
