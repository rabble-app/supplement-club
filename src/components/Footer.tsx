		...
		<footer className="flex flex-col items-center pt-[40px] pb-[40px] lg:pt-[60px] lg:px-[32px] lg:pb-[30px] bg-cream1">
			<div className="container-width grid gap-[24px] lg:grid-cols-[1fr_805px] lg:gap-[0]">
				<div className="flex flex-col gap-[24px]">
					<p className="text-[24px] leading-[27px] font-bold italic text-black">
						Supplement Club
					</p>
				...
				<div className="grid lg:grid-cols-3 gap-[24px] lg:gap-[85px]">
					<div>
						<p className="text-[18px] leading-[21px] font-bold font-figree text-black1">
							Shop
						</p>
						<p className="text-[15px] leading-[18px] mt-[12px] font-figree text-black1">
					...
					<div>
						...
						<Link
							className="text-[15px] leading-[18px] mt-[12px] font-figree text-black1 flex"
							href="/login"
						>
							Log In
						</Link>
