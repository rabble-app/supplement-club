...
>(({ className, children, ...props }, ref) => (
	<AccordionPrimitive.Header className="flex">
		<AccordionPrimitive.Trigger
			ref={ref}
			className={cn(
				"flex flex-1 items-center justify-between py-[24px] text-[16px] md:text-[18px] leading-[30px] font-bold font-helvetica text-blue transition-all hover:cursor-pointer text-left [&[data-state=open]>svg]:rotate-180",
				className,
			)}
			{...props}
		>
