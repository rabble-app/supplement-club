...
export default function SubscriptionUnregisterDialog({
  confirmAction,
}: Readonly<{
  confirmAction: () => void;
}>) {
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button className="text-red flex justify-center items-center mx-auto text-[17px] leading-[22px] font-bold font-inconsolata">
          <Image
      ...
      <DialogContent border={"rounded"} className="sm:max-w-[600px] gap-[16px]">
        <DialogHeader className="flex flex-row justify-between items-center h-[38px]">
          <DialogTitle className="text-[18px] leading-[28px] font-helvetica font-[400] h-[32px]">
            Are you sure you want to unregister yourself?
          </DialogTitle>
