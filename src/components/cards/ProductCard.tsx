...
export default function ProductCard(product: Readonly<IProductCardModel>) {
    return (
        <div className="grid gap-y-[24px] border-[1px] border-grey3 p-[16px] relative bg-white">
            ...
            {product.isComming && (
                <p className="text-[36px] leading-[41px]  bg-[#FBF89F] py-[6px] px-[10px] font-[400] absolute top-[200px] left-[0] right-[0] text-blue font-inconsolata text-center">Coming Soon</p>
            )}
            <Image
                src={product.src}
                alt={product.altSrc}
            ...
            <div className="grid gap-y-[16px]">
                ...
                <div className="grid gap-y-[8px]">
                    <p className="leading-[18px] text-black font-inconsolata text-base font-normal uppercase">{product.corporation}</p>
                    <p className="text-[24px] leading-[23px] font-[400] text-black font-hagerman">{product.name}</p>
				...
				<div className="grid grid-cols-[18px_1fr] gap-x-[4px] items-center">
                    ...
                    <p className="leading-[18px] text-black text-base">{product.ingredient}</p>
                </div>

                <div className="text-[20px] leading-[23px] text-grey4 font-inconsolata">RRP <span className="text-[20px] leading-[23px] font-bold line-through">£{product.rrpPrice}</span> <span className="text-[20px] leading-[23px] font-[400] text-blue">{product.rrpDiscount}% OFF</span></div>

                <Button className="bg-blue font-bold" asChild>
                    <Link href="#" className="flex justify-between py-[16px] px-[24px] w-full"><span className="leading-[18px] font-bold font-inconsolata text-lg">Join Team </span><span className="leading-[18px] font-bold font-inconsolata">£{product.price.toFixed(2)}</span></Link>
                </Button>
