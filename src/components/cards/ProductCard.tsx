...
export default function ProductCard(product: Readonly<IProductCardModel>) {
	return (
		<div className="grid gap-y-[24px] border-[1px] border-grey3 p-[16px] relative bg-white">
			...
			{product.isComming && (
				<p className="text-[36px] leading-[41px] text-white bg-blue py-[6px] px-[10px] absolute top-[200px] left-[0] right-[0] text-center">
					Coming Soon
				</p>
			)}
			<Image src={product.src} alt={product.altSrc} width={365} height={300} />
			<div className="grid gap-y-[16px]">
				...
				<div className="grid gap-y-[8px]">
					...
					<p className="text-[20px] leading-[23px] font-bold text-black">
						{product.name}
					</p>
				...
				<div className="grid grid-cols-[18px_1fr] gap-x-[4px] items-center">
					...
					<p className="leading-[18px] text-black">
						100% Magnesium Bisglycinate TRAACS
					</p>
				</div>

				<div className="text-[20px] leading-[23px] text-grey4">
					RRP{" "}
					<span className="text-[20px] leading-[23px] font-bold line-through">
						£{product.rrpPrice}
					</span>{" "}
					<span className="text-[20px] leading-[23px] font-bold text-blue">
				...
				<Button className="bg-blue font-bold" asChild>
					...
					>
						<span className="leading-[18px] font-bold">Join Team </span>
						<span className="leading-[18px] font-bold">
