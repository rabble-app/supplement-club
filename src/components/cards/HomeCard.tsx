	...
	return (
		<div className="grid gap-y-[16px]">
			<div className="flex gap-x-[8px] items-center">
				...
				<span className="text-[20px] md:text-[28px] leading-[23px] md:leading-[32px] font-bold text-blue">
					{model.title}
				</span>
			</div>
			<div className="text-[16px] md:text-[20px] leading-[18px] md:leading-[24px] font-bold text-black">
				{model.subtitle}
			</div>
